...
from .utils.pokeapi import get_pokemon_name, get_pokemon_data, get_pokemon_stats
...
def get_pokemon_stats_for_battle(pokemon_id):
    """
        Returns parsed pokemon stats
    """
    return get_pokemon_stats(pokemon_id)
